...
**Phase 11 next:** W17c Docker-Compose CI workflow (`.github/workflows/atlas-arcadedb-smoke.yml`) + actual cross-backend byte-determinism run against a live ArcadeDB sidecar + benchmark capture replacing ADR-010 §4.10 estimates with measured numbers (embedded-mode reconsideration trigger at p99 > 15 ms). Then Phase 12 = W18 Mem0g Layer-3 cache; Phase 13 = W19 v2.0.0-beta.1 ship convergence milestone.
