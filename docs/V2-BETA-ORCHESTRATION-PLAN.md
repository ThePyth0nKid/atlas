...
> - Phase 11.5 SHIPPED — this consolidation commit (CHANGELOG + master-plan §6 + decisions Welle-17c closure row + dependency-graph status flip + handoff §0z3 W17c SHIPPED narrative).
> - Phase 12 next — W18 Mem0g Layer-3 cache (ADR-Atlas-012 reserved); depends on W17c-validated ArcadeDB stability.
