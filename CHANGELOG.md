...
**V2-β Phase 4 + 5 + 6 + 7 + 8 + 9 + 10 + 11 + 12 all landed on master 2026-05-13 → 2026-05-15 — `v2.0.0-alpha.3` candidate.** Phase 12 ships W18 Mem0g Layer-3 cache **design** (spike + ADR + plan-doc); W18b implementation is the next welle and lands separately.
